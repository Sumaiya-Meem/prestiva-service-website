      ...
      <div className="container">
        ...
        <div className="areas-grid" style={{ display: 'flex', gap: '30px', justifyContent: 'center', flexWrap: 'wrap' }}>
          {siteConfig.serviceAreasDetailed.map((area, index) => (
            <div key={index} className="area-card" style={{ flex: '1', maxWidth: '400px', padding: '40px', backgroundColor: 'var(--white)', borderRadius: '20px', boxShadow: '0 10px 40px rgba(0,0,0,0.05)', textAlign: 'center' }}>
              <div className="area-icon" style={{ fontSize: '2.5rem', color: 'var(--primary-gold)', marginBottom: '20px' }}><FaMapMarkerAlt /></div>
